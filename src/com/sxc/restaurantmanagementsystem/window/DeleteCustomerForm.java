...
public class DeleteCustomerForm extends javax.swing.JFrame {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            CustomerDAO dao=new CustomerDaoImpl(new DBConnection(DriverManager.getConnection(url, user,password)));
            Customer customer=new Customer();
            customer.setCustomerId(Integer.parseInt(txtItemId.getText()));
            if(dao.delete(customer)>0){
