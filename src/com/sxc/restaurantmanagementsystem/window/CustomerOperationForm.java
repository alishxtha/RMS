 ...
 */
public class CustomerOperationForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnDisplay.setText("Display Customer");
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        DeleteCustomerForm form=new DeleteCustomerForm();
        form.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerOperationForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerOperationForm().setVisible(true);
            }
        });
    }
